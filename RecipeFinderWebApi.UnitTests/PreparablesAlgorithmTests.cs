    ...
    public class PreparablesAlgorithmTests
    {
        ...
        public void Initialize()
        {
            ...
            handler = new RecipeHandler(new RecipeRepo(context, user), new RecipeCategoryRelationRepo(context), new RequirementsListRepo(context),
                new Logic.PreparableRecipesAlgorithm(recipeHandler, kitchenHandler, new UnitTypeHandler(new UnitTypeRepo(context), new IngredientUnitTypeRelationRepo(context)), new IngredientRepo(context)));
